var Pagination = function (obj) {
     /*
        ...
        arguments&typeof:
             0.table parent >selector string
             1.table >json
             2.maxRows >number
...
//    }
//    $('body').delegate('.ps_body', 'click', function () {
//        $('.ps_active').removeClass('ps_active');
//        $(this).addClass('ps_active');
//        $('#tab_box').html(manageData.getTable(dataPoll[0], { cls: 'table table-hover  table-bordered' }, +$(this).text()));
        
//    })
//    $('body').delegate('.ps_loops', 'click', function () {
//        var that = + $(this).attr('type');
//        var len = $('.pagination .ps_body').length;
//        var nowIndex = (+$('.ps_active>a').text()) - 1;
//        var nextVal = nowIndex + that;
//        nextVal === len ? nextVal = 0 : nextVal;
//        nextVal < 0 ? nextVal = len - 1 : nextVal;

//        $('.pagination .ps_body').eq(nextVal).trigger('click');
